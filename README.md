...
متجر إلكتروني شامل لبيع العسل، البن، البهارات، المشروبات، الأطعمة، والحلويات في اليمن، مع إمكانية إدارة الطلبات، المستخدمين، والمدفوعات. الموقع يعمل بكفاءة ويدعم جميع الوظائف الأساسية والإدارية.

## الوظائف الرئيسية

* تصفح المنتجات حسب التصنيفات (عسل، بهارات، أطعمة، مشروبات، حلويات...)
* عرض تفاصيل كل منتج وتقييمه وسعره
* إضافة المنتجات إلى سلة الشراء
* حساب إجمالي الأسعار في سلة التسوق
* صفحة لإتمام الشراء
* اختيار طريقة الدفع (عند الاستلام، بطاقة ائتمان، باي بال، بايتم...)
* تقديم الطلب وتأكيده
* عرض الطلبات السابقة
* تسجيل الدخول كأدمن مع صلاحيات:
...
* **من نحن**
* **اتصل بنا** (مذكورة أدناه)

## تقنيات مستخدمة

* **Frontend:** HTML, CSS, JavaScript (مع استخدام Bootstrap)
* **Backend:** PHP 8.2.12
* **قاعدة البيانات:** MySQL
* **خادم الويب:** Apache/2.4.58 (localhost)

## التواصل معنا

* **البريد:** [example@gmail.com](mailto:example@gmail.com)
* **ساعات العمل:** 09:00 ص إلى 10:00 م
* **الهواتف:** +967780887739 / +967770530345
* **روابط مواقع التواصل:**

  * [واتساب](https://wa.me/message/J524XB4MO5VCA1)
  * [موقعي الشخصي](https://ishaq770530245.github.io/portfolio/)
...
* إنشاء الطلب
* اختيار الدفع
* إضافة / تعديل / حذف المنتجات والمستخدمين
* لوحة التحكم للإدمن

## ملاحظات إضافية

* تمت تجربة المشروع على خادم محلي (localhost)
* يجب التأكد من إعداد ملف `.htaccess` في Apache بشكل صحيح لتجنب أخطاء مثل "Not Found" عند حذف العناصر
.
...
<img width="1428" height="763" alt="image" src="https://github.com/user-attachments/assets/02387c9b-2d1e-43bf-ac21-f7a48d515041" />
